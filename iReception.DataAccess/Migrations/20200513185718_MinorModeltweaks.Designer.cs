...
namespace iReception.DataAccess.Migrations
{
    ...
    [Migration("20200513185718_MinorModeltweaks")]
    partial class MinorModeltweaks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iReception.Models.Entities.HotelCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("iReception.Models.Entities.MinuteServiceToReservation", b =>
                {
                    ...
                    b.HasKey("ReservationId", "MinuteServiceId");

                    b.HasIndex("MinuteServiceId");

                    b.ToTable("MinuteServicesToReservation");
                });

            modelBuilder.Entity("iReception.Models.Entities.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("iReception.Models.Entities.MinuteServiceToReservation", b =>
                {
                    b.HasOne("iReception.Models.Entities.MinuteService", "MinuteService")
                        .WithMany("MinuteServiceToReservations")
                        .HasForeignKey("MinuteServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("iReception.Models.Entities.Reservation", "Reservation")
                        .WithMany("MinuteServicesReserved")
